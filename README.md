...
### DevOps
<img alt="git,github,bash,linux,docker,nginx,wordpress,mysql,postgresql" src="https://skillicons.dev/icons?i=git,github,bash,linux,docker,nginx,wordpress,mysql,postgresql"/>
